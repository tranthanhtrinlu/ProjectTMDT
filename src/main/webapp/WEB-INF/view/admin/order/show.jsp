...
<head>
    ...
    <title>Manager Orders - Key Board Store</title>
                                ...
                                <c:forEach var="order" items="${orders}">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="/admin/order/update/${order.id}" class="btn btn-warning btn-sm mx-2">Update</a>
                                            <a href="/admin/order/delete/${order.id}" class="btn btn-danger btn-sm">Delete</a>
                                            <c:if test="${order.status == 'PENDING'}">
                                                <form action="/admin/order/confirm/${order.id}" method="post" style="display:inline;">
