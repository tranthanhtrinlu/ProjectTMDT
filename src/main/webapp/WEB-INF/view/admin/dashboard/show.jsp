...
<head>
    ...
    <title>Dashboard - Key Board Store</title>
        ...
        <main>
            <div class="container-fluid px-4">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form id="revenueChartForm" class="mb-3">
                            <div class="row">
                                <div class="col-md-3">
                                    <label for="rangeType">Loại thời gian</label>
                                    <select id="rangeType" class="form-control">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" id="startDate" class="form-control" placeholder="Chọn ngày">
                                </div>
                                <div class="col-md-3">
                                    <label for="endDate">Đến ngày</label>
                                    <input type="text" id="endDate" class="form-control" placeholder="Chọn ngày">
                                </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form id="categoryChartForm" class="mb-3">
                            <div class="row">
                                <div class="col-md-3">
