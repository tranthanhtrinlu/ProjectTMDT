...
<%--                                                </div>--%>
<%--                                                <div class="small mt-2"><a href="/forgot-password">Forgot Password?</a></div>--%>
<%--                                            </div>--%>
<%--                                        </div>--%>
<%--                                    </div>--%>
<%--                                </div>--%>
                        ...
                        <div class="card shadow-lg border-0 rounded-lg mt-5">
                            ...
                            <div class="card-body">
                                <form method="post" action="/login">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input class="form-control" type="email" placeholder="name@example.com" name="username" required />
                                        <label>Email address</label>
                                    </div>
                                    <div class="form-floating mb-3">
                            ...
                            <div>
                                <div style="text-align: center"><span>Or use</span></div>
                                <div class="d-flex justify-content-center align-items-center my-3" style="gap: 20px">
                                    <a href="/oauth2/authorization/google" title="Login with Google">
                                        <img height="40" width="40" src="/client/img/provider/default-google.png" />
                                    </a>
                                    <a href="/oauth2/authorization/github" title="Login with Github">
